  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        <div className="space-y-2">
          <Label htmlFor="agent-website">{t("website")}</Label>
          <Input
            id="agent-website"
            type="url"
            value={website}
        ...
        <div className="space-y-2">
          <Label htmlFor="agent-goal">{t("mainGoal")}</Label>
          <Textarea
            id="agent-goal"
            value={description}
        ...
        <div className="space-y-2">
          <span className="text-title-sm font-medium text-ink">{t("humanHandoff")}</span>
          <p className="text-body-sm text-body">
            {t("humanHandoffDescription")}
          </p>
