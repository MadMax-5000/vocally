...
function Checkbox({
  ...
  return (
    ...
    >
      ...
      >
        <HugeiconsIcon icon={Tick02Icon} strokeWidth={2} className="group-data-[state=indeterminate]:hidden" />
